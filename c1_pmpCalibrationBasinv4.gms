...
parameter chPMP, cpar, tstland, tstreswat, watnotuse_agr, watnotuse_res, testwatagr;
...
watnotuse_agr(c) = WNU2_agr.l(c);
watnotuse_res(c) = WNU2_res.l(c);
...
display chPMP, cpar, tstreswat,tstland,watnotuse_agr, watnotuse_res, testwatagr,Rw0, RW.l, RW_price.l, RW_ALPHA.l, price_par;


execute_unload 'basedata\cparBasinV4.gdx' cpar ;

execute 'gdxxrw.exe basedata\cparBasinV4.gdx o= basedata\cparBasinV4.xlsx par=cpar rng=cpar!A1' ;
